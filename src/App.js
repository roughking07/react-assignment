...
function App() {
  return (
    ...
    <Search />
    <span style={{'font-size':26}}>&nbsp;&nbsp; Paracetamol </span>&nbsp;&nbsp;<span style={{'font-size':12}}> (128 products) </span> &nbsp;<span style={{'background-color':'teal','color':'white'}}> Aceclofenac <i class="fa-solid fa-xmark"></i> &nbsp;
